      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* FEATURES */}
            <div className="bg-[#f4f4f4] rounded-xl p-6 shadow">
            ...
            <div className="bg-[#f4f4f4] rounded-xl p-6 shadow">
              ...
              <button
                ...
                className="text-green-700 text-sm mt-3 font-medium"
              >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#f4f4f4] rounded-xl p-6 shadow">
              ...
              <button className="w-full border border-gray-300 py-2 rounded-lg text-sm hover:bg-gray-50 text-black font-medium">
                View Seller Profile
              </button>
            </div>
